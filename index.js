     ...
     MongoClient.connect(url, function(err, db) {
      ...
      dbo.collection("SECONDsub1").find({}).toArray(function(err, result) {
        ...
        function call(result)
        {
         ...
         res.write("<p style='margin-left:200px;font-weight:bold'> Excellent: &nbsp; &nbsp; "+E.toFixed(2)+"% <input style='height:20px;width:"+E*25+"px;background-color:rgb(250,150,10);'></p>");
         res.write("<p style='margin-left:200px;font-weight:bold'> VeryGood:&nbsp; &nbsp;"+V.toFixed(2)+"%  <input style='height:20px;width:"+V*25+"px;background-color:rgb(250,150,10);'></p>");
         res.write("<p style='margin-left:200px;font-weight:bold'> Good: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; "+G.toFixed(2)+"%  <input style='height:20px;width:"+G*25+"px;background-color:rgb(250,150,10);'></p>");
         res.write("<p style='margin-left:200px;font-weight:bold'> Satisfaction: "+S.toFixed(2)+"%  <input style='height:20px;width:"+S*25+"px;background-color:rgb(250,150,10);'></p>");
         res.write("<p style='margin-left:200px;font-weight:bold'> Poor:  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; "+P.toFixed(2)+"%  <input style='height:20px;width:"+P*25+"px;background-color:rgb(250,150,10);'><hr><br><br><br></p>");
